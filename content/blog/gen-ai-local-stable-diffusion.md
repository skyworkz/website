...
{{<img src="/img/blog/user-interface.png" class="img-fluid" title="AUTOMATIC1111's web-app" width="75%">}}
...
{{<img src="/img/blog/model-name.png" class="img-fluid" title="Selection of the model's checkpoint"  width="75%">}}
...
{{<img src="/img/blog/txt2img.png" class="img-fluid" title="The generated anime image of a machine learning engineer from stable difussion." width="65%">}}
...
{{<img src="/img/blog/original.jpeg" class="img-fluid" title="A selfie, cropped to the *512 x 512* image size that would best work for an image-to-image render using stable diffusion."  width="60%">}}
...
{{<img src="/img/blog/model-name.jpeg" class="img-fluid" title="The choice of the model used for altering a photo to an anime version."  width="30%">}}
...
{{<img src="/img/blog/anime1.jpeg" class="img-fluid" style="float:left; margin-right: 10px;" title="The best version of an anime image of the photo uploaded."  width="45%">}}
{{<img src="/img/blog/anime2.jpeg" class="img-fluid" style="float:left" title="A tougher version with sharper edges of the anime image."  width="45%">}}
